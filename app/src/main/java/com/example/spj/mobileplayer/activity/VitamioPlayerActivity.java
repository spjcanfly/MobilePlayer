...
public class VitamioPlayerActivity extends Activity {
    ...
    private void setListener() {
        ...
        videoview.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(MediaPlayer mp) {
                ...
                seekbarVideo.setMax(VitamioPlayerActivity.this.duration);
                //设置总时长
                tvDuration.setText(utils.stringForTime(VitamioPlayerActivity.this.duration));
                //发消息更新seekbar
    ...
    private void showErrorDialog() {
        ...
        builder.setTitle("提示");
        builder.setMessage("播放出错了，请检查网络或文件是否损坏！");
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SHOW_NETSPEED:
                    //显示网络速度
                    String netspeed = utils.getNetSpeed(VitamioPlayerActivity.this);
                    tvBuffer.setText(netspeed);
                    tvLoading.setText(netspeed);
    ...
    private void showSwitchPlayer() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("提示");
        builder.setMessage("当前是万能播放器，是否切换到系统播放器？");
